...
Namespace inctpxa
    Module modVoucher
        ...
        Public Sub main(ByVal CmdArgs As String())
            ...
            Sys.InitMessage(modVoucher.sysConn, modVoucher.oLan, "ISTran")
        ...
        Public Const SysID As String = "ISTran"
        Public tbcDetail As DataGridTextBoxColumn() = New DataGridTextBoxColumn(30) {}
