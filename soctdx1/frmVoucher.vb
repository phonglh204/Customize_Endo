...
Public Class frmVoucher
    ...
    Private Sub frmVoucher_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim oS1 As New VoucherLibObj(colS1, "ten_vv", modVoucher.sysConn, modVoucher.appConn, "dmvv", "ma_vv", "ten_vv", "Job", "1=1", modVoucher.tblDetail, Me.pnContent, True, Me.cmdEdit)
    ...
    Private colTen_vt, colS1 As DataGridTextBoxColumn
