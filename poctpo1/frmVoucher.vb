...
Public Class frmVoucher
    ...
    Private Sub InitializeComponent()
        ...
        Me.lblT_thue.Size = New System.Drawing.Size(51, 16)
        ...
        Me.lblT_ck.Size = New System.Drawing.Size(58, 16)
        ...
        Me.txtFnote1.Location = New System.Drawing.Point(88, 71)
        ...
        Me.lblOng_ba.Location = New System.Drawing.Point(2, 48)
    ...
    Private Sub txtSo_luong_valid(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If (Decimal.Compare(num, num5) <> 0) Then
            ...
            End If
            Dim view As DataRowView = modVoucher.tblDetail.Item(Me.grdDetail.CurrentRowIndex)
            If Information.IsDBNull(RuntimeHelpers.GetObjectValue(view.Item("gia_nt"))) Then
                view.Item("gia_nt") = 0
            End If
            If Information.IsDBNull(RuntimeHelpers.GetObjectValue(view.Item("gia"))) Then
                view.Item("gia") = 0
            End If
            view.Item("so_luong") = num
            Dim args As Object() = New Object() {ObjectType.MulObj(view.Item("gia_nt"), num), num2}
            Dim copyBack As Boolean() = New Boolean() {False, True}
            If copyBack(1) Then
                num2 = ByteType.FromObject(args(1))
            End If
            view.Item("tien_nt") = RuntimeHelpers.GetObjectValue(LateBinding.LateGet(Nothing, GetType(Fox), "Round", args, Nothing, copyBack))
            Dim objArray2 As Object() = New Object() {ObjectType.MulObj(view.Item("gia"), num), num3}
            copyBack = New Boolean() {False, True}
            If copyBack(1) Then
                num3 = ByteType.FromObject(objArray2(1))
            End If
            view.Item("tien") = RuntimeHelpers.GetObjectValue(LateBinding.LateGet(Nothing, GetType(Fox), "Round", objArray2, Nothing, copyBack))
            objArray2 = New Object() {ObjectType.DivObj(ObjectType.MulObj(view.Item("Tien_nt"), zero), 100), num2}
            copyBack = New Boolean() {False, True}
            If copyBack(1) Then
                num2 = ByteType.FromObject(objArray2(1))
            End If
            view.Item("thue_nt") = RuntimeHelpers.GetObjectValue(LateBinding.LateGet(Nothing, GetType(Fox), "Round", objArray2, Nothing, copyBack))
            objArray2 = New Object() {ObjectType.DivObj(ObjectType.MulObj(view.Item("Tien"), zero), 100), num3}
            copyBack = New Boolean() {False, True}
            If copyBack(1) Then
                num3 = ByteType.FromObject(objArray2(1))
            End If
    ...
    Private Sub txtFnote1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtFnote1.TextChanged

    End Sub

    Private Sub txtOng_ba_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtOng_ba.TextChanged
